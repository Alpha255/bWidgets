...
auto bwFont::getKerningDistance(const bwFontGlyph& left, const bwFontGlyph& right) const
    -> FixedNum<F16p16>
{
...
auto bwFont::FontGlyphCache::getCachedGlyph(const bwFont& font, const char character) const
    -> const bwFontGlyph&
{
