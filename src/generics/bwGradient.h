...
namespace bWidgets
{
	 ...
	 *
	 * The implementation is currently pretty simple and limited, it's however all
	 * we need for now. More features like unlimited stops at custom positions could
	 * be added if needed.
	 */
	class bwGradient
	{
